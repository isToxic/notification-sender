package com.zgr.notification.sender.service.http.impl;
...
import com.zgr.notification.sender.model.send.CascadeChainLink;
import com.zgr.notification.sender.model.send.CustomPayload;
import com.zgr.notification.sender.model.send.Data;
import com.zgr.notification.sender.model.send.Message;
import com.zgr.notification.sender.model.send.NotificationRequest;
import com.zgr.notification.sender.model.send.PushContent;
import com.zgr.notification.sender.model.send.PushData;
import com.zgr.notification.sender.model.send.ScheduleInfo;
...
public class SendNotificationServiceImpl implements SendNotificationService {
    ...
    private static final String GORZDRAV_MACROBREND_VALUE = "ГОРЗДРАВ";
    ...
    private NotificationRequest buildRequest(IntCommQuery intCommQuery) {
        String smsServiceNum = intCommQuery.getMacrobrend().equals(GORZDRAV_MACROBREND_VALUE) ? serviceNumberSMSGorzdrav : serviceNumberSMS366;
        String pushServiceNum = intCommQuery.getMacrobrend().equals(GORZDRAV_MACROBREND_VALUE) ? serviceNumberPushGorzdrav : serviceNumberPush366;
